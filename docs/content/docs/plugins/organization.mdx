...
Active organization is the workspace in which the user is currently working. By default when the user is signed in the active organization is set to `null`. You can set the active organization to the user session.
