...
<Callout>
  You don't have to construct the plugin as a function, but it's recommended to do so. This way, you can pass options to the plugin and it's consistent with the built-in plugins.
</Callout>
